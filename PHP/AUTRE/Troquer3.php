...
FROM articles 
INNER JOIN client ON ID_article=$ident";*/

$sql1= "SELECT * FROM articles WHERE ID_article=$ident"  ;
...
$prix1=$row1['PRIX'];
    if ($prix!==$prix1 ){
        ...
        echo "Les prix des deux articles sont compatibles donc vous pouvez echanger!<br>";
