...
session_start();
     try{
       ...
       if (isset($_POST['nom_a'])&&isset($_POST['mat'])&&isset($_POST['qlte'])&&isset($_POST['classe'])&&isset($_POST['prix'])){
        $_SESSION['nom_a']=$_POST['nom_a'];
        $_SESSION['mat']=$_POST['mat'];
        $_SESSION['qlte']=$_POST['qlte'];
        ...
        if (isset($_FILES['img']) && $_FILES['img']['error'] === 0) {
         ...
         $imageName = $_FILES['img']['name'];
          ...
          if (move_uploaded_file($tempName, $uploadPath)) {
              $preparation2 = "INSERT INTO articles (NOM,NOMS,MATIERE,QUALITE,CLASSE,PRIX,IMAGES,EMAIL) VALUES ('$nom','$nom_c','$mat','$qlte','$classe','$prix', '$imageName','$email_c')";
...
<form action="Postes.php" method="post" id="form" enctype="multipart/form-data">
        <center><table >
           ...
           <tr>
            ...
            <td><input type="text" name="nom_a" id="nom" required></td>
           </tr>
           <tr>
