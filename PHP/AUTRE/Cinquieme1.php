...
<header>
    ...
    <h2 style="text-align:center; margin-top:70px; font-weight:200px; font-size:30px;">FAITES VOTRE CHOIX!</h1>
       <h2 style="text-align:center; margin-top:30px; font-weight:200px; font-size:30px; color:red;"><u>CINQUIEMES</U></h2>
  ...
  /*  echo"<section class='produit'>
    ...
    while ($row1 = $result->fetch_assoc()) {
        ...
        echo "<form action='Troquer5.php?id=".$row1['ID_article']."' method='post' enctype='multipart/form-data'>";
