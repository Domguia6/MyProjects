...
<header>
     <div class="bg_img" >
        ...
        <a href="Connexion2.php">MonCompte</a>
            <a href="inscription.php"> Troquer
                <div class="login">
    ...
    <h2 style="text-align:center; margin-top:70px; font-weight:200px; font-size:30px;">FAITES VOTRE CHOIX!</h1>
       <h2 style="text-align:center; margin-top:30px; font-weight:200px; font-size:30px; color:indigo;"><u>QUATRIEMES</U></h2>
  ...
  /*  echo"<section class='produit'>
    ...
    try{
       ...
       $sql = "SELECT articles.NOM AS nom_article, articles.MATIERE, articles.PRIX,articles.IMAGES, articles.QUALITE, client.NOMS  AS nom_client, client.EMAIL, client.TELEPHONE, client.CLASSES , articles.ID_article
       FROM articles 
       INNER JOIN client ON articles.NOMS = client.NOMS
       WHERE  articles.CLASSE='4ième'";
    ...
    while ($row1 = $result->fetch_assoc()) {
        ...
        echo "<BR>Qualite: ".$row1["QUALITE"];
        echo "<br>Vendeur: ".$row1["nom_client"];
        echo "<br>Classe: ".$row1["CLASSES"]."<br>";
        echo "<form action='Troquer4.php?id=".$row1['ID_article']."' method='post' enctype='multipart/form-data'>";
        echo "<input type='hidden' name='id' value='".$row1['ID_article']."'><br>";
        echo "<center><input type='submit' value='Troquer' class='submit'></center>";
      //  echo "<br>Email:<a href='mailto:".$row1["EMAIL"]."'>".$row1["EMAIL"]."</a>";
      
     //   echo "<br><center><button><a href='troquer.php'>Troquer</a></button></center>";
        echo "</div >";
        $counter++;
...
<footer>
    <p>Inscrivez-vous nombreux afin de profiter de nombreuses ressources disponibles sur ce site!&nbsp;&nbsp;&nbsp;&nbsp;<button style="background-color: rgb(17, 16, 15); border-color: black;"><a href="inscription.php" style=" text-align: center; color: rgb(217, 221, 245);">Inscription</a></button></p>
    <div class="icones">
